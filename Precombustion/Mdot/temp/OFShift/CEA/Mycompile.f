...
C     WRITE (*,99001)
      ...
      open (55,file='Pressure.d') 
      write(55,*)
      close(55)
      open (55,file='Temperature.d') 
      write(55,*)
      close(55)
      open (55,file='Gamma.d') 
      write(55,*)
      close(55)
      open (55,file='Mole.d') 
      write(55,*)
...
C PRESSURE
      ...
      open(55,file='Pressure.d',access='append')
...
C TEMPERATURE
      ...
      open(55,file='Temperature.d',access='append')
...
C MOLECULAR WEIGHT
      ...
      open(55,file='Mole.d',access='append')
...
C GAMMA(S)
      ...
      open(55,file='Gamma.d',access='append')
...
C SPECIFIC IMPULSE
      ...
      open (55,file='isp.d',access='append') 
