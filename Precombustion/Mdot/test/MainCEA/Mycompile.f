...
C TEMPERATURE
      ...
      WRITE (55,Fmt) 'T, K            ',(Ttt(j),j=1,Npt)
      close(55)
C DENSITY
      DO i = 1,Npt
...
C MOLECULAR WEIGHT
      ...
      WRITE (55,Fmt) 'M, (1/n)        ',(Wm(j),j=1,Npt)
      close(55)
...
C GAMMA(S)
      ...
      WRITE (55,Fmt) 'GAMMAs          ',(Gammas(j),j=1,Npt)
      close(55)
C SONIC VELOCITY
      Fmt(7) = '1,'
      DO i = 1,Npt
...
C SPECIFIC IMPULSE
      ...
      WRITE (55,Fmt) fi,(Spim(j),j=2,Npt)
      close(55)
      IF ( Nplt.GT.0 ) THEN
        Spim(1) = 0
        Aeat(1) = 0
