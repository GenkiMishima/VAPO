...
f = sp.genfromtxt("CEAData/Ideal.d")
#g = sp.genfromtxt("CEAData/P33.d")
#h = sp.genfromtxt("CEAData/P12.d")
...
#plt.scatter(fY,fZ,color='b')
#plt.plot(sY,sZ)
#plt.legend(["Ideal_CEA(0.400MPa)","Ideal_CEA(0.528MPa)","Ideal_CEA(0.600MPa)","Ex","Ex_CEA"],loc = 'upper right')
plt.legend(["Ideal_CEA(0.400MPa)","Ideal_CEA(0.528MPa)","Ideal_CEA(0.600MPa)"],loc = 'upper right')
